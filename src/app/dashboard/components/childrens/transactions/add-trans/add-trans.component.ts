...
@Component({
  selector: 'add-trans',
  standalone: true,
  imports: [DatepickerComponent, DropdownComponent, InputNumberModule, FormsModule, InputComponent, ButtonComponent, IconComponent, CommonModule],
