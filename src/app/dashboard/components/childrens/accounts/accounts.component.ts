...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ButtonComponent, IconComponent, SearchComponent, LottieComponent, TableComponent, SidebarModule, ConfirmDialogComponent, AddAccComponent],
